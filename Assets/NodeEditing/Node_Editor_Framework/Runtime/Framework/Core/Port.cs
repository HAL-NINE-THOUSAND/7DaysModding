...
//         bool IsSamePort(IPortLegacy port);
//         Node Node { get; set; }
//         
//         bool Connected { get; }
...
//         public Connection RemoveConnection(IPortLegacy port);
...
//     public class Port<T> : IPortLegacy
//     {
...
//         
//         public bool IsSamePort(IPortLegacy port)
//         {
//             
...
//                 {
//                     list.RemoveAt(x);
//                     Debug.LogWarning("connections remove");
//                     // if (conn.SourcePort == this)
