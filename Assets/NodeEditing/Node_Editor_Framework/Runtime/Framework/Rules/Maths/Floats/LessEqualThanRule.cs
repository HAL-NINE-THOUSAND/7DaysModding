...
{
    [RuleMenu(Path = "Maths/Float/Less or equal", Hidden = true)]
    [RuleTitle(Title = "<=")]
    public class FloatLessEqualThanRule : TargetRule<bool, float>
    {
        public const string Identifier = "Hal.Float.LET";

        public FloatLessEqualThanRule()
        {
            RuleName = Identifier;
            ...
            ConvertTypes.Add(typeof(int), LessEqualThanRule.Identifier);
        }
