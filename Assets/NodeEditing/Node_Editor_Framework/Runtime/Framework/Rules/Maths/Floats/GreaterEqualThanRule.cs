...
{
    [RuleMenu(Path = "Maths/Float/Greater or Equal", Hidden = true)]
    [RuleTitle(Title = ">")]
    public class FloatGreaterEqualThanRule : TargetRule<bool, float>
    {
        public const string Identifier = "Hal.Float.GET";

        public FloatGreaterEqualThanRule()
        {
            RuleName = Identifier;
            ...
            ConvertTypes.Add(typeof(int), GreaterEqualThanRule.Identifier);
        }
