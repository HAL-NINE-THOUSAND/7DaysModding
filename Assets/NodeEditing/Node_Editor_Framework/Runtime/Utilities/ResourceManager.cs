...
namespace NodeEditorFramework.Utilities 
{
	...
	public static class ResourceManager 
	{
        ...
        public static Func<string, Texture2D> TextureLoader;

		public static Func<string, Shader> ShaderLoader; 
...
//			return path;
		...
		public static Texture2D LoadTexture (string texPath)
		{
			...
			Texture2D tex = TextureLoader?.Invoke(texPath) ?? LoadResource<Texture2D>(texPath);
