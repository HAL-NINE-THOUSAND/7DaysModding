...
namespace NodeEditorFramework.Standard
{
	...
	public class NodeInspector : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			// foreach (var port in node.IncomingConnections)
			// {
			// 	string labelPrefix = port.SourcePort.Direction == Direction.In ? "Input " : (port.SourcePort.Direction == Direction.Out ? "Output " : "");
