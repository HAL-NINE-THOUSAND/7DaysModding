...
// 	{
// 		public const string ID = nameof(MyTestNode);
// 		public new string GetID { get { return ID; } }
//
// 		public override string Title { get { return "Testing/My Test Node"; } }
// 		public override Vector2 DefaultSize { get { return new Vector2 (200, 100); } }
//
//
// 		public IPortLegacy Input1;
// 		public IPortLegacy Input2;
//
// 		public IPortLegacy Output1;
//
// 		public MyTestNode()
// 		{
//
...
//
// 			
// 			var input1Value = Input1.Connected ? Input1.Connections[0].SourcePortLegacy.GetValue<int>() : Input1.GetValue<int>();
// 			var input2Value = Input2.Connected ? Input2.Connections[0].SourcePortLegacy.GetValue<int>() : Input2.GetValue<int>(); 
//
// 			// First input
// 			if (Input1.Connected)
// 				GUILayout.Label (Input1.Knob.name + ": " + input1Value);
// 			else
// 				Input1.SetValue(RTEditorGUI.IntField(GUIContent.none, Input1.GetValue<int>(), null));
...
// 			else
// 				Input2.SetValue(RTEditorGUI.IntField(GUIContent.none, Input2.GetValue<int>(), null));
...
// 			int b = 0;
// 			if (Input1.Connected)
// 				a = Input1.Connections[0].SourcePortLegacy.GetValue<int>();
// 			else
// 				a = Input1.GetValue<int>();
// 			
// 			if (Input2.Connected)
// 				b = Input2.Connections[0].SourcePortLegacy.GetValue<int>();
// 			else
